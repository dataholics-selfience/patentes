...
import { Menu, X, FlaskConical, CreditCard, LogOut, MessageCircle, Clock, BarChart3 } from 'lucide-react';
...
const Layout = () => {
  ...
  const [activeTab, setActiveTab] = useState<'consultation' | 'dashboard'>('consultation');
