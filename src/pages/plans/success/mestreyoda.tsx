...
export default function MestreYodaSuccess() {
  ...
  useEffect(() => {
    const activatePlan = async () => {
      try {
        await handlePlanSuccess('mestreyoda');
        ...
        {loading ? (
          <>
            ...
            <p className="text-gray-400">
              Aguarde enquanto configuramos seu plano Mestre Yoda...
            </p>
          </>
        ) : (
          <>
            ...
            <p className="text-xl text-gray-300">
              Seu plano Mestre Yoda foi ativado com sucesso!
            </p>
          </>
        )}
      </div>
