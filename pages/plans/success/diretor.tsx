...
export default function DiretorSuccess() {
  ...
  useEffect(() => {
    const activatePlan = async () => {
      try {
        await handlePlanSuccess('diretor');
        ...
        {loading ? (
          <>
            ...
            <p className="text-gray-600">
              Aguarde enquanto configuramos seu plano Diretor com 700 consultas mensais...
            </p>
          </>
        ) : (
          <>
            ...
            <p className="text-xl text-gray-700">
              Seu plano Diretor foi ativado com sucesso!
            </p>
            <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
              <p className="text-blue-800">
                <strong>700 consultas mensais</strong> foram adicionadas à sua conta.
              </p>
            </div>
          </>
        )}
